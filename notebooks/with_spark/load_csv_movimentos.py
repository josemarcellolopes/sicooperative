...
filesystem = '../dags/data/airflow_dags/data'
csv_file = 'movimentos.csv'
csv_delimiter = ','

# Table information
table = 'movimento'
columns = ['id_movimento', 'vlr_transacao_movimento', 'descricao_transacao_movimento', 'data_movimento', 'id_cartao']
pk = 'id_movimento'
